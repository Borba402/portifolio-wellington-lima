...
const WHATSAPP_URL = "https://wa.me/5511956057279";

const contacts = [
  {
    label: "WhatsApp",
    value: "+55 (11) 95605-7279",
    description: "Resposta rápida · Chame agora",
    href: WHATSAPP_URL,
    icon: (
        ...
        <div className="grid lg:grid-cols-2 gap-10 lg:gap-24 items-center">
          ...
          <div className="flex flex-col gap-4">
            ...
            <motion.a
              ...
              onMouseEnter={(e) => {
                (e.currentTarget as HTMLAnchorElement).style.boxShadow = "0 12px 40px rgba(37,211,102,0.50)";
                (e.currentTarget as HTMLAnchorElement).style.background = "#1ebe5a";
              }}
              onMouseLeave={(e) => {
                (e.currentTarget as HTMLAnchorElement).style.boxShadow = "0 8px 28px rgba(37,211,102,0.30)";
